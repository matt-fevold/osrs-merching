class Item:
    def __init__(self, wiki_id, name, limit, members, high_alch):
        self.low_time = None
        self.low_price = None
        self.high_time = None
        self.high_price = None
        self.volume = None
        self.volume_time = None
        self.wiki_id = int(wiki_id)
        self.name = name
        self.limit = limit
    ...
    def __str__(self):
        return ("{\n\twiki_id : " + str(self.wiki_id) +
                ...
                ",\n\tvolume_time : " + str(self.volume_time) +
                ",\n}")
